...
/**
 * Servlet implementation class listPayment
 */
@WebServlet("/listPayment.do")
public class listPayment extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<PayVO> list = service.listPayment(memNum);
	    
		request.setAttribute("paymentList", list);
		
		request.getRequestDispatcher("js/myPayment/myPaymentList.jsp").forward(request, response);
	}
