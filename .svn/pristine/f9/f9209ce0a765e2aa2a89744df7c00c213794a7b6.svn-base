...
.tiket2 a:link, .tiket2 a:visited {
...
.tiket2 a:hover, .tiket2 a:active {
	...
	<div id="root">
		<div class="root1">
			...
			<header class="header1">
				...
				<div class="tiket1">
					<h2 class="tiketname">이용권관리</h2>
					<ul class="tiket2">
						<li><a href="<%= request.getContextPath() %>/jsp/ticket/myTicketList.jsp" target="main">이용권내역</a></li>
						<li><a href="<%= request.getContextPath() %>/jsp/ticket/myPaymentList.jsp" target="main">결제내역</a></li>
					</ul>
					<iframe src="<%= request.getContextPath() %>/jsp/ticket/myTicketList.jsp" scrolling="yes" name="main" frameborder="0"></iframe>
