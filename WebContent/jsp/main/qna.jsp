...
.qnamenu a:link, .qnamenu a:visited {
...
.qnamenu a:hover, .qnamenu a:active {
...
%>					
			...
			<div class="qna1">
				<h2 class="qnaname">문의</h2>
				<ul class="qnamenu">
					<li><a href="<%= request.getContextPath() %>/jsp/notice/jaju.jsp" target="if">자주묻는질문</a></li>
					<li><a href="<%= request.getContextPath() %>/jsp/notice/answer.jsp" target="if">1:1문의하기</a></li>
					<li><a href="<%= request.getContextPath() %>/jsp/notice/myAnswer.jsp" target="if">내가 쓴 문의</a></li>
				</ul>
				<iframe src="<%= request.getContextPath() %>/jsp/notice/jaju.jsp" name="if" scrolling="no" frameborder="0"></iframe>
