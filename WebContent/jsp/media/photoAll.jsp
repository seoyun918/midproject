	  ...
	  <div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<form method="post" action="<%= request.getContextPath() %>/insertPhoto.do" enctype="multipart/form-data">
			  ...
			  <div style="float: right;">
                ...
                <input id="fup" type="file" accept="image/*, video/*" multiple name="uploadFiles" style="display: none;">
              </div>
