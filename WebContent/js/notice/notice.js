...
function modifyNotice(){
	...
	$.ajax({
		...
		success : function(res){
			...
			title = $('#modifyModal input[name=ntc_title]').val();
			console.log(title);
	...
	$.ajax({
		...
		success : function(res){
			  ...
			  $.each(res.datas, function(i, v){    
				   ...
				   code += '<div class="subdate">' + v.wdate + '</div> <br>';
		...
		success : function(res){
			  ...
			  $.each(res.datas, function(i, v){    
				  ...
				  code += '<div class="panel panel-default">';
				   ...
				   code += '<div class="subdate">' + v.wdate + '</div>';
				   code += '<p class="p3 listp3">';
				   code += v.content;
				   code += '</p>';
